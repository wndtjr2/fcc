...
<div class="modal__content">
    ...
    <form method="post" id="EditAddressFrm" action="/Modal/modalAddressEdit">
            ...
            <div class="modal__address--add">
                ...
                <div class="form__division is-zoom">
                    <div class="profile__sect--left">
                        ...
                        <input type="text" class="input__box" name="deliv_last_name" id="deliv_last_name" value="<?=$address['deliv_last_name'];?>">
                ...
                <div class="profile__sect--right">
                        ...
                        <input type="text" class="input__box" name="deliv_first_name" id="deliv_first_name" value="<?=$address['deliv_first_name'];?>">
                ...
                <div class="form__division is-zoom">
                    <div class="profile__sect--left">
                        ...
                        <input type="text" id="address" class="input__box"  name="address" readonly value="<?=$address['address'];?>">
                    ...
                    <div class="profile__sect--right">
                        ...
                        <input type="text" id="address2" class="input__box" name="address2" value="<?=$address['address2'];?>">
                ...
                <div class="form__division is-zoom">
                    <div class="profile__sect--left">
                        ...
                        <input type="text" name="zipcode" id="zipcode" class="input__box" readonly value="<?=$address['zipcode'];?>">
                ...
                <div class="form__division is-zoom">
                    ...
                    <input type="text" name="deliv_phone_num" id="deliv_phone_num" class="input__box" value="<?=$address['phone_decrypt'];?>">
        ...
        <div class="modal__address--bottom is-zoom">
            ...
            <a href="#" class="buttons save" id="saveEditAddress">
